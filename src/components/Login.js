  ...
  return (
    <div>
      ...
      <div className="absolute">
          <img alt='bg-logo' src={BACKGROUND_IMAGE} className="h-screen object-cover" />
          </div>

      <form
        onSubmit={(e) => e.preventDefault()}
        className="w-full md:w-3/12 p-12 m-36 bg-black/80 absolute mx-auto right-0 left-0 text-white rounded-lg">
